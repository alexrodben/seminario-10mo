                ...
                <tr>
                    ...
                    <td class="align-middle text-center">
                        ...
                        @if ($quotation->status === \App\Enums\QuotationStatus::PENDING)
                            ...
                            <x-button.complete class="btn-icon" route="{{ route('quotations.update', $quotation->uuid) }}" onclick="return confirm('¿Está seguro de completar la cotización No. {{ $quotation->reference }}?')"/>
