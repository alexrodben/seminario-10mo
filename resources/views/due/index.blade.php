...
<div class="page-body">
    @if($orders->isEmpty())
    {{-- <x-empty
        title="No compras no encontradas"
        message="Trata de ajustar tu búsqueda o filtrar lo que estás buscando"
        button_label="{{ __('Agregar tu primera compra') }}"
    ...
    <div class="empty">
        ...
        <p class="empty-title">No hay ventas con saldos pendientes encontradas</p>
    </div>
    @else
    <div class="container-xl">
        <div class="card">
            <div class="card-header">
                <div>
                    <h3 class="card-title">
                        {{ __('Lista de ventas con saldo vencido') }}
                    </h3>
                </div>
